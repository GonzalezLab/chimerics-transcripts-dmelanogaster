...
# mkdir ${DIR}/ANALYSES/deNovoTranscriptAnnotationReference/assembly

# # Head
# for assembly in `less ${DIR}/DATA/genomeAssembly/genomeAssembly.txt`
#     do
#         mkdir ${DIR}/ANALYSES/deNovoTranscriptAnnotationReference/assembly/${assembly}
#         mkdir ${DIR}/ANALYSES/deNovoTranscriptAnnotationReference/assembly/${assembly}/Head
#         for dataRna in `less ${DIR}/DATA/RNAseqData/files/${assembly}_RNAseq_head.txt`
#             do
#                 stringtie ${DIR}/ANALYSES/deNovoTranscriptAnnotationReference/map/${assembly}/Head/${dataRna}.bam -l ${dataRna} -p 12 -G ${DIR}/DATA/FlyBase_r6.31/dmel-chr-r6.31.gtf -o ${DIR}/ANALYSES/deNovoTranscriptAnnotationReference/assembly/${assembly}/Head/${dataRna}.gtf
#             done
#     done
...
# for assembly in `less ${DIR}/DATA/genomeAssembly/genomeAssembly.txt`
#     do
#         mkdir ${DIR}/ANALYSES/deNovoTranscriptAnnotationReference/assembly/${assembly}/Gut
#         for dataRna in `less ${DIR}/DATA/RNAseqData/files/${assembly}_RNAseq_gut.txt`
#             do
#                 stringtie ${DIR}/ANALYSES/deNovoTranscriptAnnotationReference/map/${assembly}/Gut/${dataRna}.bam -l ${dataRna} -p 12 -G ${DIR}/DATA/FlyBase_r6.31/dmel-chr-r6.31.gtf -o ${DIR}/ANALYSES/deNovoTranscriptAnnotationReference/assembly/${assembly}/Gut/${dataRna}.gtf
#             done
#     done
...
# for assembly in `less ${DIR}/DATA/genomeAssembly/genomeAssembly.txt`
#     do
#         mkdir ${DIR}/ANALYSES/deNovoTranscriptAnnotationReference/assembly/${assembly}/Ovary
#         for dataRna in `less ${DIR}/DATA/RNAseqData/files/${assembly}_RNAseq_ovary.txt`
#             do
#                 stringtie ${DIR}/ANALYSES/deNovoTranscriptAnnotationReference/map/${assembly}/Ovary/${dataRna}.bam -l ${dataRna} -p 12 -G ${DIR}/DATA/FlyBase_r6.31/dmel-chr-r6.31.gtf -o ${DIR}/ANALYSES/deNovoTranscriptAnnotationReference/assembly/${assembly}/Ovary/${dataRna}.gtf
#             done
#     done
...
# stringtie --merge -p 12 -G ${DIR}/DATA/FlyBase_r6.31/dmel-chr-r6.31.gtf -o ${DIR}/ANALYSES/deNovoTranscriptAnnotationReference/assembly/stringtie_merged.gtf ${DIR}/ANALYSES/deNovoTranscriptAnnotationReference/mergelist.txt
# mkdir ${DIR}/ANALYSES/deNovoTranscriptAnnotationReference/assembly/mergedSamples
# cd ${DIR}/ANALYSES/deNovoTranscriptAnnotationReference/assembly/mergedSamples
# gffcompare -r ${DIR}/DATA/FlyBase_r6.31/dmel-chr-r6.31.gtf -G -o mergedSamples ${DIR}/ANALYSES/deNovoTranscriptAnnotationReference/assembly/stringtie_merged.gtf
...
# mkdir ${DIR}/ANALYSES/deNovoTranscriptAnnotationReference/ballgown

# # Head
# for assembly in `less ${DIR}/DATA/genomeAssembly/genomeAssembly.txt`
#     do
#     	mkdir ${DIR}/ANALYSES/deNovoTranscriptAnnotationReference/ballgown/${assembly}
#     	mkdir ${DIR}/ANALYSES/deNovoTranscriptAnnotationReference/ballgown/${assembly}/Head
#         for dataRna in `less ${DIR}/DATA/RNAseqData/files/${assembly}_RNAseq_head.txt`
#             do
#                 mkdir ${DIR}/ANALYSES/deNovoTranscriptAnnotationReference/ballgown/${assembly}/Head/${dataRna}
#                 stringtie -e -B -p 12 -G ${DIR}/ANALYSES/deNovoTranscriptAnnotationReference/assembly/stringtie_merged.gtf -o ${DIR}/ANALYSES/deNovoTranscriptAnnotationReference/ballgown/${assembly}/Head/${dataRna}/${dataRna}.gtf ${DIR}/ANALYSES/deNovoTranscriptAnnotationReference/map/${assembly}/Head/${dataRna}.bam
#             done
#         done
...
#     do
#     	#mkdir ${DIR}/ANALYSES/deNovoTranscriptAnnotationReference/ballgown/${assembly}
#     	mkdir ${DIR}/ANALYSES/deNovoTranscriptAnnotationReference/ballgown/${assembly}/Gut
#         for dataRna in `less ${DIR}/DATA/RNAseqData/files/${assembly}_RNAseq_gut.txt`
#             do
#             	mkdir ${DIR}/ANALYSES/deNovoTranscriptAnnotationReference/ballgown/${assembly}/Gut/${dataRna}
#                 stringtie -e -B -p 12 -G ${DIR}/ANALYSES/deNovoTranscriptAnnotationReference/assembly/stringtie_merged.gtf -o ${DIR}/ANALYSES/deNovoTranscriptAnnotationReference/ballgown/${assembly}/Gut/${dataRna}/${dataRna}.gtf ${DIR}/ANALYSES/deNovoTranscriptAnnotationReference/map/${assembly}/Gut/${dataRna}.bam
#             done
#         done
...
#     do
#     	#mkdir ${DIR}/ANALYSES/deNovoTranscriptAnnotationReference/ballgown/${assembly}
#     	mkdir ${DIR}/ANALYSES/deNovoTranscriptAnnotationReference/ballgown/${assembly}/Ovary
#         for dataRna in `less ${DIR}/DATA/RNAseqData/files/${assembly}_RNAseq_ovary.txt`
#             do
#             	mkdir ${DIR}/ANALYSES/deNovoTranscriptAnnotationReference/ballgown/${assembly}/Ovary/${dataRna}
#                 stringtie -e -B -p 12 -G  ${DIR}/ANALYSES/deNovoTranscriptAnnotationReference/assembly/stringtie_merged.gtf -o ${DIR}/ANALYSES/deNovoTranscriptAnnotationReference/ballgown/${assembly}/Ovary/${dataRna}/${dataRna}.gtf ${DIR}/ANALYSES/deNovoTranscriptAnnotationReference/map/${assembly}/Ovary/${dataRna}.bam
#             done
#         done

# ASSEMBLY IMPROVED

mkdir ${DIR}/ANALYSES/deNovoTranscriptAnnotationReference/ballgownImproved

# Head
for assembly in `less ${DIR}/DATA/genomeAssembly/genomeAssembly.txt`
    do
        mkdir ${DIR}/ANALYSES/deNovoTranscriptAnnotationReference/ballgownImproved/${assembly}
        mkdir ${DIR}/ANALYSES/deNovoTranscriptAnnotationReference/ballgownImproved/${assembly}/Head
        for dataRna in `less ${DIR}/DATA/RNAseqData/files/${assembly}_RNAseq_head.txt`
            do
                mkdir ${DIR}/ANALYSES/deNovoTranscriptAnnotationReference/ballgownImproved/${assembly}/Head/${dataRna}
                stringtie -e -B -p 12 -G ${DIR}/ANALYSES/deNovoTranscriptAnnotationReference/assemblyImproved/stringtie_merged.gtf -o ${DIR}/ANALYSES/deNovoTranscriptAnnotationReference/ballgownImproved/${assembly}/Head/${dataRna}/${dataRna}.gtf ${DIR}/ANALYSES/deNovoTranscriptAnnotationReference/map/${assembly}/Head/${dataRna}.bam
            done
        done
...
for assembly in `less ${DIR}/DATA/genomeAssembly/genomeAssembly.txt`
    do
        #mkdir ${DIR}/ANALYSES/deNovoTranscriptAnnotationReference/ballgownImproved/${assembly}
        mkdir ${DIR}/ANALYSES/deNovoTranscriptAnnotationReference/ballgownImproved/${assembly}/Gut
        for dataRna in `less ${DIR}/DATA/RNAseqData/files/${assembly}_RNAseq_gut.txt`
            do
                mkdir ${DIR}/ANALYSES/deNovoTranscriptAnnotationReference/ballgownImproved/${assembly}/Gut/${dataRna}
                stringtie -e -B -p 12 -G ${DIR}/ANALYSES/deNovoTranscriptAnnotationReference/assemblyImproved/stringtie_merged.gtf -o ${DIR}/ANALYSES/deNovoTranscriptAnnotationReference/ballgownImproved/${assembly}/Gut/${dataRna}/${dataRna}.gtf ${DIR}/ANALYSES/deNovoTranscriptAnnotationReference/map/${assembly}/Gut/${dataRna}.bam
            done
        done
...
for assembly in `less ${DIR}/DATA/genomeAssembly/genomeAssembly.txt`
    do
        #mkdir ${DIR}/ANALYSES/deNovoTranscriptAnnotationReference/ballgownImproved/${assembly}
        mkdir ${DIR}/ANALYSES/deNovoTranscriptAnnotationReference/ballgownImproved/${assembly}/Ovary
        for dataRna in `less ${DIR}/DATA/RNAseqData/files/${assembly}_RNAseq_ovary.txt`
            do
                mkdir ${DIR}/ANALYSES/deNovoTranscriptAnnotationReference/ballgownImproved/${assembly}/Ovary/${dataRna}
                stringtie -e -B -p 12 -G  ${DIR}/ANALYSES/deNovoTranscriptAnnotationReference/assemblyImproved/stringtie_merged.gtf -o ${DIR}/ANALYSES/deNovoTranscriptAnnotationReference/ballgownImproved/${assembly}/Ovary/${dataRna}/${dataRna}.gtf ${DIR}/ANALYSES/deNovoTranscriptAnnotationReference/map/${assembly}/Ovary/${dataRna}.bam
            done
        done
