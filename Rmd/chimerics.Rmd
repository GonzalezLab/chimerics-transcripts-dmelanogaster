...
ggsave(filename="FIGURES/Figure1C.pdf",plot=cowplot::plot_grid(a,b,ncol = 1), height = 12, width = 10)
...
chisq.test(matrix(c(group1_shortInsertions,group2_shortInsertions, group1_total-group1_shortInsertions, group2_total-group2_shortInsertions),nrow=2))
...
chisq.test(matrix(c(s2c["Overlap & AS insertions-All","num_strain_specific"],
              s2c["Internal insertions-All","num_strain_specific"],s2c["Overlap & AS insertions-All","num_total_transcripts"]-s2c["Overlap & AS insertions-All","num_strain_specific"],
              s2c["Internal insertions-All","num_total_transcripts"]-s2c["Internal insertions-All","num_strain_specific"]),nrow=2))
...
chisq.test(matrix(c(s2c["Overlap & AS insertions-All","num_strain_shared"]+s2c["Overlap & AS insertions-All","num_strain_pol"],
              s2c["Internal insertions-All", "num_strain_shared"] + s2c["Internal insertions-All", "num_strain_pol"],s2c["Overlap & AS insertions-All","num_total_transcripts"]-(s2c["Overlap & AS insertions-All","num_strain_shared"]+s2c["Overlap & AS insertions-All","num_strain_pol"]),
              s2c["Internal insertions-All","num_total_transcripts"]-(s2c["Internal insertions-All", "num_strain_shared"] + s2c["Internal insertions-All", "num_strain_pol"])),nrow=2))
...
chisq.test(matrix(c(s2c["Overlap & AS insertions-≥120","num_strain_specific"],
              s2c["Internal insertions-≥120","num_strain_specific"],
              s2c["Overlap & AS insertions-≥120","num_total_transcripts"]-s2c["Overlap & AS insertions-≥120","num_strain_specific"],
              s2c["Internal insertions-≥120","num_total_transcripts"]- s2c["Internal insertions-≥120","num_strain_specific"]),nrow=2))
...
chisq.test(matrix(c(s2c["Overlap & AS insertions-≥120","num_strain_shared"]+s2c["Overlap & AS insertions-≥120","num_strain_pol"],
              s2c["Internal insertions-≥120", "num_strain_shared"] + s2c["Internal insertions-≥120", "num_strain_pol"],s2c["Overlap & AS insertions-≥120","num_total_transcripts"]-(s2c["Overlap & AS insertions-≥120","num_strain_shared"]+s2c["Overlap & AS insertions-≥120","num_strain_pol"]),
              s2c["Internal insertions-≥120","num_total_transcripts"]-(s2c["Internal insertions-≥120", "num_strain_shared"] + s2c["Internal insertions-≥120", "num_strain_pol"])),nrow=2))
...
chisq.test(matrix(c(head_n, ovary_n,head_total-head_n, ovary_total-ovary_n),nrow=2))

prop.test(x=c(head_n, gut_n),n=c(head_total, gut_total))
chisq.test(matrix(c(head_n, gut_n,head_total-head_n, gut_total-gut_n),nrow=2))


prop.test(x=c(ovary_n, gut_n),n=c(ovary_total, gut_total))
chisq.test(matrix(c(ovary_n, gut_n,ovary_total-ovary_n, gut_total-gut_n),nrow=2))
...
chisq.test(matrix(c(s3b["head","n_total_chimerics_bp_specific"],
              s3b["gut","n_total_chimerics_bp_specific"],s3b["head","n_total_chimerics"]-s3b["head","n_total_chimerics_bp_specific"],
              s3b["gut","n_total_chimerics"]- s3b["gut","n_total_chimerics_bp_specific"]),nrow=2))
...
chisq.test(matrix(c(s3b["head","n_total_chimerics_bp_specific"],
              s3b["ovary","n_total_chimerics_bp_specific"],s3b["head","n_total_chimerics"]-s3b["head","n_total_chimerics_bp_specific"], s3b["ovary","n_total_chimerics"]-s3b["ovary","n_total_chimerics_bp_specific"]),nrow=2))
...
chisq.test(matrix(c(s3b["gut","n_total_chimerics_bp_specific"],
              s3b["ovary","n_total_chimerics_bp_specific"],s3b["gut","n_total_chimerics"]-s3b["gut","n_total_chimerics_bp_specific"], s3b["ovary","n_total_chimerics"]-s3b["ovary","n_total_chimerics_bp_specific"]),nrow=2))
...
prop.test(x=c(s3b["head","n_total_chimerics_bp_specific"],
          ...
          n=c(s3b["head","n_total_chimerics"],
              s3b["head","n_total"]))
chisq.test(matrix(c(s3b["head","n_total_chimerics_bp_specific"],
              s3b["head","bp_specific"],s3b["head","n_total_chimerics"]-s3b["head","n_total_chimerics_bp_specific"],
              s3b["head","n_total"]-s3b["head","bp_specific"]),nrow=2))
...
prop.test(x=c(s3b["gut","n_total_chimerics_bp_specific"],
          ...
          n=c(s3b["gut","n_total_chimerics"],
              s3b["gut","n_total"]))
chisq.test(matrix(c(s3b["gut","n_total_chimerics_bp_specific"],
              s3b["gut","bp_specific"],s3b["gut","n_total_chimerics"]-s3b["gut","n_total_chimerics_bp_specific"],
              s3b["gut","n_total"]-  s3b["gut","bp_specific"]),nrow=2))
...
chisq.test(matrix(c(s3b["ovary","n_total_chimerics_bp_specific"],
              s3b["ovary","bp_specific"],s3b["ovary","n_total_chimerics"]-s3b["ovary","n_total_chimerics_bp_specific"],
              s3b["ovary","n_total"]-   s3b["ovary","bp_specific"]),nrow=2))
```
...
t1.c<-chisq.test(matrix(c(genes_3_utr, totalSequenceAnalyzed3UTR,genes_total-genes_3_utr, totalSequenceAnalyzed-totalSequenceAnalyzed3UTR),nrow=2))

t2 <- prop.test(x=c(genes_5_utr, totalSequenceAnalyzed5UTR), n=c(genes_total, totalSequenceAnalyzed))
t2.c<-chisq.test(matrix(c(genes_5_utr, totalSequenceAnalyzed5UTR,genes_total-genes_5_utr, totalSequenceAnalyzed-totalSequenceAnalyzed5UTR),nrow=2))

t3 <- prop.test(x=c(genes_internal, totalSequenceAnalyzedMiddle), n=c(genes_total, totalSequenceAnalyzed))
t3.c<-chisq.test(matrix(c(genes_internal, totalSequenceAnalyzedMiddle ,genes_total-genes_internal, totalSequenceAnalyzed-totalSequenceAnalyzedMiddle),nrow=2))
...
write.table(table_s4a, file="ANALYSES/1DescriptiveAnalysis/Table_S4A_fixed.tab", col.names = T, row.names = F, sep = "\t", quote = F)
...
chisq.test(matrix(c(255,97, 1008-255,509-97),nrow=2))

prop.test(x=c(483,242), n=c(1008,509)) 
chisq.test(matrix(c(483,242,1008-483,509-242),nrow=2))

prop.test(x=c(270,170), n=c(1008,509))
chisq.test(matrix(c(270,170,1008-270,509-170),nrow=2))

# 120
prop.test(x=c(158,56), n=c(586,243))
chisq.test(matrix(c(158,56, 586-158,243-56),nrow=2))

prop.test(x=c(321,132), n=c(586,243)) 
chisq.test(matrix(c(321,132, 586-321,243-132),nrow=2))

prop.test(x=c(107,55), n=c(586,243))
chisq.test(matrix(c(107,55, 586-107,243-55),nrow=2))
...
chisq.test(matrix(c(42, 414, 586-42, 1199-414),nrow=2))

prop.test(x=c(25, 143), n=c(482, 506))
chisq.test(matrix(c(25, 143, 482-25, 506-143),nrow=2))
...
table_s4d$position<-factor(table_s4d$position, levels=c("5'UTR","Internal exon","3'UTR"),labels = c("5'UTR","Internal\nexon","3'UTR"))
...
ggsave(plot_grid(f3a,f3b,  align="h", axis = "b", labels = c("A","B"), label_size = 18,  rel_widths = c(0.45, 1)),file="FIGURES/Figure3_r.png", width = 15, height = 6.5)
ggsave(plot_grid(f3a,f3b,  align="h", axis = "b", labels = c("A","B"), label_size = 18,  rel_widths = c(0.45, 1)),file="FIGURES/Figure3_r.pdf", width = 15, height = 6.5)
ggsave(plot_grid(f3a,f3b,  align="h", axis = "b", labels = c("A","B"), label_size = 18,  rel_widths = c(0.45, 1)),file="FIGURES/Figure3_r.svg", width = 15, height = 6.5)
```
...
chisq.test(matrix(c(70,1178,90-70,1953.8-1178), nrow = 2))

prop.test(x=c(70,120), n=c(90,146))
...
chisq.test(matrix(c(75,68,90-75,90-68), nrow = 2))
...
chisq.test(matrix(c(55,1178,75,1953.8), nrow = 2))
 prop.test(x=c(55,120),n=c(75,146))
chisq.test(matrix(c(55,120,75-55,146-120), nrow = 2))

 prop.test(x=c(52,16),n=c(68,68))
chisq.test(matrix(c(52,1178,68,1953.8), nrow = 2))
 prop.test(x=c(52,120),n=c(68,146))
chisq.test(matrix(c(52,120,68-52,146-120), nrow = 2))
...
write.table(resultTEfamFilter, file="ANALYSES/1DescriptiveAnalysis/Table_S5D_fixed.tab", quote = F, col.names = T, row.names = F, sep = "\t")
...
plot_grid(plot_fimo_roo_solo_ltr,plot_fimo_ine,plot_fimo_bp_sp, ncol = 1,labels="AUTO", align = "hv", rel_heights = c(0.5,1.3,1),label_size = 18)
```
...
ggsave(plot_grid(fig5a, plotB, align = "h", axis = "t", nrow=2,labels = c('A', 'B'), label_size = 18, rel_heights =  c(1.5,3))
       ,file="FIGURES/Figure5.png", width = 7.8, height = 8)
...
dataGO_BP$shortName <- factor(dataGO_BP$shortName, levels=rev(c("Regulation of biological process","Regulation of cellular process",  "Negative regulation of biological process", "Epithelium development", "Transcription from RNA polymerase II promoter", "Single-multicellular organism process", "Multicellular development"  ,"Regulation of RNA biosynthetic process" , "Morphogenesis" , "Cell communication and signaling" )))
dataGO_BP<-dataGO_BP %>% arrange(factor(shortName, levels = rev(c("Regulation of biological process", "Regulation of cellular process",  "Negative regulation of biological process", "Epithelium development", "Transcription from RNA polymerase II promoter", "Single-multicellular organism process", "Multicellular development" ,"Regulation of RNA biosynthetic process" , "Morphogenesis" , "Cell communication and signaling"  ))))
...
plot_grid(GO_BP_plot, GO_BP_g1_plot, GO_BP_g2_plot, GO_MF_plot, GO_MF_g1_plot, GO_MF_g2_plot, ncol=1, align = 'v', axis = 'l', labels=c("A","","","B","",""), label_size=18, rel_heights = c(1, 1.2,1.1,0.7,0.6,0.8))
